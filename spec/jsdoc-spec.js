describe("JSDoc grammar", function () {
  ...
  describe("inline tags", function () {
    ...
    it("tokenises tags with a preceding description", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "Description text",
        scopes: ["source.js", "comment.block.documentation.js", "constant.other.description.jsdoc"],
      });
      expect(tokens[4]).toEqual({
        value: "]",
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** Text [Description text]{@tutorial target|Description} */",
      ));
      expect(tokens[0]).toEqual({
        value: "/**",
        scopes: [
    ...
    it("tokenises inline tags which follow block tags", function () {
      let { tokens } = grammar.tokenizeLine(
        "/** @param {object} variable - this is a {@link linked} description */",
      );
      expect(tokens[0]).toEqual({
        value: "/**",
        scopes: [
      ...
      expect(tokens[3]).toEqual({
        value: "param",
        scopes: ["source.js", "comment.block.documentation.js", "storage.type.class.jsdoc"],
      });
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: [
      ...
      expect(tokens[9]).toEqual({
        value: "variable",
        scopes: ["source.js", "comment.block.documentation.js", "variable.other.jsdoc"],
      });
      expect(tokens[10]).toEqual({
        value: " - this is a ",
        scopes: ["source.js", "comment.block.documentation.js"],
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {object} variable - this is a [description with a]{@link example}. */",
      ));
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: [
  ...
  describe("block tags", function () {
    ...
    it("tokenises @param tags with a description", function () {
      let { tokens } = grammar.tokenizeLine(
        "/** @param {object} variable this is the description */",
      );
      expect(tokens[0]).toEqual({
        value: "/**",
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @argument {object} variable this is the description */",
      ));
      expect(tokens[0]).toEqual({
        value: "/**",
        scopes: [
    ...
    describe("default @param values", function () {
      it("tokenises unquoted values", function () {
        let { tokens } = grammar.tokenizeLine(
          "/** @param {object} [variable=default value] this is the description */",
        );
        expect(tokens[5]).toEqual({
          value: "{",
          scopes: [
      ...
      it("tokenises object literals", function () {
        let { tokens } = grammar.tokenizeLine(
          '/** @param {Object} [variable={a: "b"}] - An object */',
        );
        expect(tokens[5]).toEqual({
          value: "{",
          scopes: [
        ...
        ({ tokens } = grammar.tokenizeLine(
          "/** @param {Object} [  variable  =  {  }  ] - Empty object */",
        ));
        expect(tokens[5]).toEqual({
          value: "{",
          scopes: [
      ...
      it("tokenises arrays", function () {
        let { tokens } = grammar.tokenizeLine(
          "/** @param {Array} [variable=[1,2,3]] - An array */",
        );
        expect(tokens[5]).toEqual({
          value: "{",
          scopes: [
        ...
        ({ tokens } = grammar.tokenizeLine(
          "/** @param {Array} [  variable  =  [  ]  ] - Empty array */",
        ));
        expect(tokens[5]).toEqual({
          value: "{",
          scopes: [
      ...
      it("flags any description text touching the closing bracket", function () {
        const { tokens } = grammar.tokenizeLine(
          '/** @param {Object} [thing={a: [], b: [0, 2], c: "String"}][Bad Description] [] [] [] */',
        );
        expect(tokens[0]).toEqual({
          value: "/**",
          scopes: [
      ...
      it("does not tokenise arrays inside strings", function () {
        let { tokens } = grammar.tokenizeLine(
          "/** @param {Object} [thing='{a: [], b: [0, 2], c: \"String\"}][Quoted Description] ['] [Unquoted Description] */",
        );
        expect(tokens[0]).toEqual({
          value: "/**",
          scopes: [
        ...
        expect(tokens[13]).toEqual({
          value: '{a: [], b: [0, 2], c: "String"}][Quoted Description] [',
          scopes: [
            "source.js",
            "comment.block.documentation.js",
            "variable.other.jsdoc",
        ...
        ({ tokens } = grammar.tokenizeLine(
          "/** @param {Object} [thing=\"{a: [], b: [0, 2], c: 'String'}][Quoted Description] [\"] [] [] */",
        ));
        expect(tokens[0]).toEqual({
          value: "/**",
          scopes: [
        ...
        ({ tokens } = grammar.tokenizeLine(
          "/** @param {Object} [thing=\"{a: [], b: [0, 2], c: 'String'}][Quoted Description] [\"][Bad Description] [] */",
        ));
        expect(tokens[14]).toEqual({
          value: '"',
          scopes: [
        ...
        ({ tokens } = grammar.tokenizeLine(
          "/** @param {Object} [thing='{a: [], b: [0, 2], c: \"String\"}][Quoted Description] ['][Bad_Unquoted Description] */",
        ));
        expect(tokens[14]).toEqual({
          value: "'",
          scopes: [
    ...
    it("tokenises @param tags with accessor-style names", function () {
      let { tokens } = grammar.tokenizeLine(
        "/** @param {object} parameter.property this is the description */",
      );
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {object} [parameter.property=default value] this is the description */",
      ));
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: [
    ...
    it("tokenises @param tags with qualified types", function () {
      let { tokens } = grammar.tokenizeLine(
        "/** @param {myNamespace.MyClass} variable this is the description */",
      );
      expect(tokens[0]).toEqual({
        value: "/**",
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {Foo~cb} variable this is the description */",
      ));
      expect(tokens[0]).toEqual({
        value: "/**",
        scopes: [
    ...
    it("tokenises @param tags with multiple types", function () {
      let { tokens } = grammar.tokenizeLine(
        "/** @param {function|string} variable this is the description */",
      );
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {string[]|number} variable this is the description */",
      ));
      expect(tokens[0]).toEqual({
        value: "/**",
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {(number|function)} variable this is the description */",
      ));
      expect(tokens[3]).toEqual({
        value: "param",
        scopes: ["source.js", "comment.block.documentation.js", "storage.type.class.jsdoc"],
    ...
    it("tokenises @param tags marked nullable or non-nullable", function () {
      let { tokens } = grammar.tokenizeLine(
        "/** @param {?number} variable this is the description */",
      );
      expect(tokens[2]).toEqual({
        value: "@",
        scopes: [
    ...
    it("tokenises @param tags using Google Closure Compiler syntax", function () {
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {Foo[].bar} variable this is the description */",
      ));
      expect(tokens[0]).toEqual({
        value: "/**",
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {Array<number>} variable this is the description */",
      ));
      expect(tokens[3]).toEqual({
        value: "param",
        scopes: ["source.js", "comment.block.documentation.js", "storage.type.class.jsdoc"],
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {Array<number>|Array<string>} variable this is the description */",
      ));
      expect(tokens[3]).toEqual({
        value: "param",
        scopes: ["source.js", "comment.block.documentation.js", "storage.type.class.jsdoc"],
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {Object<string, number>} variable this is the description */",
      ));
      expect(tokens[3]).toEqual({
        value: "param",
        scopes: ["source.js", "comment.block.documentation.js", "storage.type.class.jsdoc"],
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {Object<string, number>|Array<number>} variable this is the description */",
      ));
      expect(tokens[3]).toEqual({
        value: "param",
        scopes: ["source.js", "comment.block.documentation.js", "storage.type.class.jsdoc"],
      ...
      expect(tokens[6]).toEqual({
        value: "Object<string, number>|Array<number>",
        scopes: ["source.js", "comment.block.documentation.js", "entity.name.type.instance.jsdoc"],
      });
      expect(tokens[7]).toEqual({
        value: "}",
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {(Array<number>|Object<string, number>)} variable this is the description */",
      ));
      expect(tokens[3]).toEqual({
        value: "param",
        scopes: ["source.js", "comment.block.documentation.js", "storage.type.class.jsdoc"],
      ...
      expect(tokens[6]).toEqual({
        value: "(Array<number>|Object<string, number>)",
        scopes: ["source.js", "comment.block.documentation.js", "entity.name.type.instance.jsdoc"],
      });
      expect(tokens[7]).toEqual({
        value: "}",
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {function()} variable this is the description */",
      ));
      expect(tokens[3]).toEqual({
        value: "param",
        scopes: ["source.js", "comment.block.documentation.js", "storage.type.class.jsdoc"],
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {function(string, number)} variable this is the description */",
      ));
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {function(string, number, ...number)} variable this is the description */",
      ));
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: [
      ...
      expect(tokens[6]).toEqual({
        value: "function(string, number, ...number)",
        scopes: ["source.js", "comment.block.documentation.js", "entity.name.type.instance.jsdoc"],
      });
      expect(tokens[7]).toEqual({
        value: "}",
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @param {function():number} variable this is the description */",
      ));
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: [
    ...
    it("tokenises function-type @return tags", function () {
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @return {function(string)} this is the description */",
      ));
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @return {function(string, number)} this is the description */",
      ));
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @return {function(string, number, ...number)} this is the description */",
      ));
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        "/** @return {function():number} this is the description */",
      ));
      expect(tokens[3]).toEqual({
        value: "return",
        scopes: ["source.js", "comment.block.documentation.js", "storage.type.class.jsdoc"],
...
`);
      ...
      expect(lines[1][3]).toEqual({
        value: "",
        scopes: ["source.js", "comment.block.documentation.js", "meta.example.jsdoc"],
      });
...
`);
      ...
      const { tokens } = grammar.tokenizeLine(
        '/** @param {Something} [value={key: [value, ["22"}] */ 20;',
      );
      expect(tokens[0]).toEqual({
        value: "/**",
        scopes: [
  ...
  describe("when the line ends without a closing bracket", () =>
    it("does not attempt to match the optional value (regression)", function () {
      const { tokens } = grammar.tokenizeLine(
        '/** @param {array} [bar = "x" REMOVE THE CLOSE BRACKET HERE.',
      );
      expect(tokens[9]).toEqual({
        value: "[",
        scopes: ["source.js", "comment.block.documentation.js"],
