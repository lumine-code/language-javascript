    ...
    it("tokenizes single-line strings", function () {
      ...
      return (() => {
        ...
        for (let scope in delimsByScope) {
          ...
          const { tokens } = grammar.tokenizeLine(delim + "x" + delim);
...
` +
          ...
          expect(lines[0][0]).toEqual({
            value: delim,
            scopes: ["source.js", scope, "punctuation.definition.string.begin.js"],
          });
          ...
          result.push(
            expect(lines[2][1]).toEqual({
              value: delim,
              scopes: ["source.js", scope, "punctuation.definition.string.end.js"],
            }),
          );
        }
        return result;
    ...
    describe("Unicode escape sequences", function () {
      ...
      it("tokenises 2-digit sequences", () =>
        (() => {
          const result = [];
          for (let scope in delimsByScope) {
            const quote = delimsByScope[scope];
            const { tokens } = grammar.tokenizeLine(quote + "\\x2011" + quote);
            ...
            expect(tokens[1]).toEqual({
              value: "\\x20",
              scopes: ["source.js", scope, "constant.character.escape.js"],
            });
      ...
      it("tokenises 4-digit sequences", () =>
        (() => {
          ...
          for (let scope in delimsByScope) {
            const quote = delimsByScope[scope];
            const { tokens } = grammar.tokenizeLine(quote + "\\u2011" + quote);
            expect(tokens[0]).toEqual({
              value: quote,
              scopes: ["source.js", scope, "punctuation.definition.string.begin.js"],
            });
      ...
      it("tokenises variable-length sequences", () =>
        (() => {
          ...
          for (let scope in delimsByScope) {
            const quote = delimsByScope[scope];
            const { tokens } = grammar.tokenizeLine(quote + "\\u{2000}" + quote);
            expect(tokens[0]).toEqual({
              value: quote,
              scopes: ["source.js", scope, "punctuation.definition.string.begin.js"],
            });
            ...
            expect(tokens[2]).toEqual({
              value: "{",
              scopes: ["source.js", scope, "constant.character.escape.js", bracketScopes[0]],
            });
            expect(tokens[3]).toEqual({
              value: "2000",
              scopes: ["source.js", scope, "constant.character.escape.js"],
            ...
            expect(tokens[4]).toEqual({
              value: "}",
              scopes: ["source.js", scope, "constant.character.escape.js", bracketScopes[1]],
            });
            result.push(
      ...
      it("highlights sequences with invalid syntax", () =>
        (() => {
          const result = [];
          for (let invalid of ["\\u", "\\u{2000", "\\u{G}"]) {
            ...
            result.push(
              expect(tokens[1]).toEqual({
                ...
                scopes: [
                  "source.js",
                  "string.quoted.double.js",
                  "invalid.illegal.unicode-escape.js",
                ],
              }),
            );
          }
      ...
      it("highlights sequences with invalid codepoints", function () {
        ...
        return (() => {
          const result = [];
          for (let codepoint of [0x5000, 0x11ffff, 0x1000000, maxCodepoint]) {
            const pointStr = codepoint.toString(16).toUpperCase().replace(/^0x/, "");
            const { tokens } = grammar.tokenizeLine('"\\u{' + pointStr + '}"');
            const pointScopes = [
              "source.js",
              "string.quoted.double.js",
            ...
            if (codepoint > maxCodepoint) {
              pointScopes.push("invalid.illegal.unicode-escape.js");
            }
            expect(tokens[0]).toEqual({
              value: '"',
              scopes: [
            ...
            expect(tokens[1]).toEqual({
              value: "\\u",
              scopes: ["source.js", "string.quoted.double.js", "constant.character.escape.js"],
            });
            expect(tokens[2]).toEqual({
              value: "{",
              scopes: [
  ...
  describe("keywords", function () {
    ...
    it("tokenizes the debugger statement", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "debugger",
        scopes: ["source.js", "keyword.other.debugger.js"],
      });
      expect(tokens[1]).toEqual({
        value: ";",
    ...
    it("tokenises an `await` keyword after a spread operator", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "...",
        scopes: ["source.js", "keyword.operator.spread.js"],
      });
  ...
  describe("built-in globals", function () {
    it("tokenizes built-in classes", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "window",
        scopes: ["source.js", "support.variable.dom.js"],
      });
  ...
  describe("instantiation", () =>
    it("tokenizes the new keyword and instance entities", function () {
      let { tokens } = grammar.tokenizeLine("new something");
      expect(tokens[0]).toEqual({
        value: "new",
        scopes: ["source.js", "meta.class.instance.constructor.js", "keyword.operator.new.js"],
      });
      expect(tokens[1]).toEqual({
        value: " ",
        scopes: ["source.js", "meta.class.instance.constructor.js"],
      });
      expect(tokens[2]).toEqual({
        value: "something",
        scopes: ["source.js", "meta.class.instance.constructor.js", "entity.name.type.instance.js"],
      });
      ...
      expect(tokens[7]).toEqual({
        ...
        scopes: [
          "source.js",
          "meta.class.instance.constructor.js",
  ...
  describe("regular expressions", function () {
    it("tokenizes regular expressions", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "g",
        scopes: ["source.js", "string.regexp.js", "meta.flag.regexp"],
      });
      ...
      expect(tokens[3]).toEqual({
        value: "et",
        scopes: ["source.js", "string.regexp.js", "meta.group.regexp"],
      });
      expect(tokens[4]).toEqual({
        value: ")",
        scopes: [
      ...
      expect(tokens[5]).toEqual({
        value: "?",
        scopes: ["source.js", "string.regexp.js", "keyword.operator.quantifier.regexp"],
      });
      expect(tokens[6]).toEqual({
        value: "/",
        scopes: ["source.js", "string.regexp.js", "punctuation.definition.string.end.js"],
      ...
      expect(tokens[5]).toEqual({
        value: "\\1",
        scopes: ["source.js", "string.regexp.js", "keyword.other.back-reference.regexp"],
      });
      expect(tokens[6]).toEqual({
        value: "/",
        scopes: ["source.js", "string.regexp.js", "punctuation.definition.string.end.js"],
      ...
      expect(tokens[3]).toEqual({
        value: "foo",
        scopes: ["source.js", "string.regexp.js", "meta.group.assertion.regexp"],
      });
      expect(tokens[4]).toEqual({
        value: ")",
        scopes: [
    ...
    it("tokenizes regular expressions inside arrow function expressions", function () {
      ...
      expect(tokens[10]).toEqual({
        value: "^",
        scopes: ["source.js", "string.regexp.js", "keyword.control.anchor.regexp"],
      });
  ...
  describe("numbers", function () {
    it("tokenizes hexadecimals", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "0x1D306",
        scopes: ["source.js", "constant.numeric.hex.js"],
      });
      ...
      expect(tokens[1]).toEqual({
        value: "_",
        scopes: ["source.js", "constant.numeric.hex.js", "meta.delimiter.numeric.separator.js"],
      });
      expect(tokens[2]).toEqual({
        value: "69A3",
        scopes: ["source.js", "constant.numeric.hex.js"],
    ...
    it("tokenizes binary literals", function () {
      ...
      expect(tokens[0]).toEqual({
        ...
        scopes: ["source.js", "constant.numeric.binary.js"],
      });
      ...
      expect(tokens[0]).toEqual({
        value: "0b011101110111010001100110n",
        scopes: ["source.js", "constant.numeric.binary.js"],
      });
      ...
      expect(tokens[1]).toEqual({
        value: "_",
        scopes: ["source.js", "constant.numeric.binary.js", "meta.delimiter.numeric.separator.js"],
      });
      expect(tokens[2]).toEqual({
        value: "0111",
        scopes: ["source.js", "constant.numeric.binary.js"],
    ...
    it("tokenizes octal literals", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "0o1411",
        scopes: ["source.js", "constant.numeric.octal.js"],
      });
      ...
      expect(tokens[1]).toEqual({
        value: "_",
        scopes: ["source.js", "constant.numeric.octal.js", "meta.delimiter.numeric.separator.js"],
      });
      expect(tokens[2]).toEqual({
        value: "7201",
        scopes: ["source.js", "constant.numeric.octal.js"],
    ...
    it("tokenizes decimals", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "_",
        scopes: ["source.js", "constant.numeric.decimal.js", "meta.delimiter.numeric.separator.js"],
      });
      expect(tokens[2]).toEqual({
        value: "456",
        scopes: ["source.js", "constant.numeric.decimal.js"],
      ...
      expect(tokens[1]).toEqual({
        value: ".",
        scopes: ["source.js", "constant.numeric.decimal.js", "meta.delimiter.decimal.period.js"],
      });
    ...
    it("does not tokenize numbers that are part of a variable", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "1_",
        scopes: ["source.js", "invalid.illegal.identifier.js"],
      });
      ...
      expect(tokens[1]).toEqual({
        value: ".",
        scopes: ["source.js", "meta.delimiter.property.period.js"],
      });
      expect(tokens[2]).toEqual({
        value: "_1",
        scopes: ["source.js", "variable.other.property.js"],
      });
  ...
  describe("operators", function () {
    it("tokenizes them", function () {
      ...
      return (() => {
        ...
        for (let operator of Array.from(operators)) {
          const { tokens } = grammar.tokenizeLine(operator);
          result.push(
            expect(tokens[0]).toEqual({
              value: operator,
              scopes: ["source.js", "keyword.operator." + operator + ".js"],
            }),
          );
        }
        return result;
    ...
    it("tokenizes spread operator", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "args",
        scopes: ["source.js", "meta.function-call.js", "meta.arguments.js"],
      });
      ...
      expect(tokens[1]).toEqual({
        value: "arguments",
        scopes: ["source.js", "variable.language.js"],
      });
    ...
    describe("increment, decrement", function () {
      it("tokenizes increment", function () {
        ...
        expect(tokens[1]).toEqual({
          value: "++",
          scopes: ["source.js", "keyword.operator.increment.js"],
        });
      });
      ...
      it("tokenizes decrement", function () {
        ...
        expect(tokens[1]).toEqual({
          value: "--",
          scopes: ["source.js", "keyword.operator.decrement.js"],
        });
      });
    });
      ...
      it("tokenizes them", () =>
        (() => {
          ...
          for (let operator of Array.from(operators)) {
            ...
            expect(tokens[1]).toEqual({
              value: operator,
              scopes: ["source.js", "keyword.operator.logical.js"],
            });
    ...
    describe("bitwise", function () {
      it("tokenizes bitwise 'not'", function () {
        ...
        expect(tokens[0]).toEqual({
          value: "~",
          scopes: ["source.js", "keyword.operator.bitwise.js"],
        });
      ...
      it("tokenizes bitwise shift operators", function () {
        ...
        return (() => {
          ...
          for (let operator of Array.from(operators)) {
            ...
            expect(tokens[1]).toEqual({
              value: operator,
              scopes: ["source.js", "keyword.operator.bitwise.shift.js"],
            });
            result.push(expect(tokens[2]).toEqual({ value: " b", scopes: ["source.js"] }));
          }
          return result;
        ...
        it("tokenizes them", function () {
          ...
          return (() => {
            ...
            for (let operator of Array.from(operators)) {
              ...
              expect(tokens[1]).toEqual({
                value: operator,
                scopes: ["source.js", "keyword.operator.assignment.compound.js"],
              });
              result.push(expect(tokens[2]).toEqual({ value: " b", scopes: ["source.js"] }));
            }
            return result;
          ...
          it("tokenizes them", function () {
            ...
            return (() => {
              ...
              for (let operator of Array.from(operators)) {
                ...
                expect(tokens[1]).toEqual({
                  value: operator,
                  scopes: ["source.js", "keyword.operator.assignment.compound.logical.js"],
                });
                result.push(expect(tokens[2]).toEqual({ value: " b", scopes: ["source.js"] }));
              }
              return result;
          ...
          it("tokenizes them", function () {
            ...
            return (() => {
              ...
              for (let operator of Array.from(operators)) {
                ...
                expect(tokens[1]).toEqual({
                  value: operator,
                  scopes: ["source.js", "keyword.operator.assignment.compound.bitwise.js"],
                });
                result.push(expect(tokens[2]).toEqual({ value: " b", scopes: ["source.js"] }));
              }
              return result;
          ...
          it("tokenizes bitwise shift", function () {
            ...
            return (() => {
              ...
              for (let operator of Array.from(operators)) {
                ...
                expect(tokens[1]).toEqual({
                  value: operator,
                  scopes: ["source.js", "keyword.operator.assignment.compound.bitwise.shift.js"],
                });
                result.push(expect(tokens[2]).toEqual({ value: " b", scopes: ["source.js"] }));
              }
              return result;
  ...
  describe("constants", function () {
    it("tokenizes ALL_CAPS variables as constants", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "MY_COOL_VAR",
        scopes: ["source.js", "constant.other.js"],
      });
      expect(tokens[3]).toEqual({ value: " ", scopes: ["source.js"] });
      expect(tokens[4]).toEqual({
        value: "=",
      ...
      expect(tokens[0]).toEqual({
        value: "OBJ",
        scopes: ["source.js", "constant.other.object.js"],
      });
    });
    ...
    it("tokenises constants with dollar signs", function () {
      ...
      return (() => {
        const result = [];
        for (let constant of Array.from(constants)) {
    ...
    it("doesn't tokenise constants without alphabetic characters", () =>
      (() => {
        const result = [];
        for (let name of ["$_", "$", "_", "$_$_$_$___$___$____$"]) {
...
`);
      expect(lines[0][0]).toEqual({
        value: "const",
        scopes: ["source.js", "storage.type.const.js"],
      });
...
`);
    ...
    it("tokenizes support constants", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "cool",
        scopes: ["source.js", "variable.other.object.js"],
      });
      expect(tokens[4]).toEqual({
        value: ".",
        scopes: ["source.js", "meta.delimiter.property.period.js"],
  ...
  describe("ES6 string templates", () =>
    it("tokenizes them as strings", function () {
  ...
  describe("HTML template strings", function () {
    ...
    it("tokenizes ES6 tagged HTML string templates", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "html",
        scopes: ["source.js", "string.quoted.template.html.js", "entity.name.function.js"],
      });
      expect(tokens[1]).toEqual({
        value: "`",
        scopes: [
          "source.js",
          "string.quoted.template.html.js",
          "punctuation.definition.string.begin.js",
        ],
      });
      expect(tokens[2]).toEqual({
        value: "hey ",
        scopes: ["source.js", "string.quoted.template.html.js"],
      });
      expect(tokens[3]).toEqual({
        value: "<",
        scopes: [
      ...
      expect(tokens[4]).toEqual({
        value: "b",
        scopes: ["source.js", "string.quoted.template.html.js", tagScope, entityScope],
      });
      expect(tokens[5]).toEqual({
        value: ">",
        scopes: [
      ...
      expect(tokens[7]).toEqual({
        value: "name",
        scopes: ["source.js", "string.quoted.template.html.js", "source.js.embedded.source"],
      });
      expect(tokens[8]).toEqual({
        value: "}",
        scopes: [
  ...
  describe("ES6 tagged Relay.QL string templates", () =>
    it("tokenizes them as strings", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "Relay",
        scopes: ["source.js", "string.quoted.template.graphql.js", "entity.name.function.js"],
      });
      expect(tokens[1]).toEqual({
        value: ".",
        scopes: [
          "source.js",
          "string.quoted.template.graphql.js",
      ...
      expect(tokens[4]).toEqual({
        value: "fragment on Foo { id }",
        scopes: ["source.js", "string.quoted.template.graphql.js"],
      });
      expect(tokens[5]).toEqual({
        value: "`",
        scopes: [
  ...
  describe("ES6 tagged Relay.QL string templates with interpolation", () =>
    it("tokenizes them as strings", function () {
      ...
      expect(tokens[6]).toEqual({
        value: "myFragment",
        scopes: ["source.js", "string.quoted.template.graphql.js", "source.js.embedded.source"],
      });
      expect(tokens[7]).toEqual({
        value: "}",
        scopes: [
  ...
  describe("ES6 tagged SQL string templates", () =>
    it("tokenizes them as strings", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "SQL",
        scopes: ["source.js", "string.quoted.template.sql.js", "entity.name.function.js"],
      });
      expect(tokens[1]).toEqual({
        value: "`",
        scopes: [
          "source.js",
          "string.quoted.template.sql.js",
          "punctuation.definition.string.begin.js",
        ],
      });
      expect(tokens[2]).toEqual({
        value: "SELECT foo FROM bar WHERE id = :id",
        scopes: ["source.js", "string.quoted.template.sql.js"],
      });
      expect(tokens[3]).toEqual({
        value: "`",
        scopes: [
  ...
  describe("ES6 tagged SQL string templates with interpolation", () =>
    it("tokenizes them as strings", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "SELECT foo FROM bar WHERE id = ",
        scopes: ["source.js", "string.quoted.template.sql.js"],
      });
      expect(tokens[3]).toEqual({
        value: "${",
      ...
      expect(tokens[4]).toEqual({
        value: "id",
        scopes: ["source.js", "string.quoted.template.sql.js", "source.js.embedded.source"],
      });
      expect(tokens[5]).toEqual({
        value: "}",
        scopes: [
  ...
  describe("ES6 class", function () {
    it("tokenizes class", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "MyClass",
        scopes: ["source.js", "meta.class.js", "entity.name.type.class.js"],
      });
    ...
    it("tokenizes class...extends", function () {
      ...
      expect(tokens[6]).toEqual({
        value: "SomeClass",
        scopes: ["source.js", "meta.class.js", "entity.other.inherited-class.js"],
      });
  ...
  describe("ES6 import", function () {
    it("tokenizes import", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "module-name",
        scopes: ["source.js", "meta.import.js", "string.quoted.double.js"],
      });
      expect(tokens[4]).toEqual({
        value: '"',
        scopes: [
    ...
    it("tokenizes default import", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "defaultMember",
        scopes: ["source.js", "meta.import.js", "variable.other.module.js"],
      });
      expect(tokens[4]).toEqual({
        value: "from",
        scopes: ["source.js", "meta.import.js", "keyword.control.js"],
    ...
    it("tokenizes default named import", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "{",
        scopes: ["source.js", "meta.import.js", "punctuation.definition.modules.begin.js"],
      });
      expect(tokens[4]).toEqual({
        value: "default",
        scopes: ["source.js", "meta.import.js", "variable.language.default.js"],
      });
      expect(tokens[6]).toEqual({
        value: "as",
        scopes: ["source.js", "meta.import.js", "keyword.control.js"],
      ...
      expect(tokens[8]).toEqual({
        value: "defaultMember",
        scopes: ["source.js", "meta.import.js", "variable.other.module-alias.js"],
      });
      expect(tokens[10]).toEqual({
        value: "}",
        scopes: ["source.js", "meta.import.js", "punctuation.definition.modules.end.js"],
      });
      expect(tokens[12]).toEqual({
        value: "from",
        scopes: ["source.js", "meta.import.js", "keyword.control.js"],
    ...
    it("tokenizes named import", function () {
      ...
      expect(tokens[6]).toEqual({
        value: ",",
        scopes: ["source.js", "meta.import.js", "meta.delimiter.object.comma.js"],
      });
      expect(tokens[8]).toEqual({
        value: "member2",
        scopes: ["source.js", "meta.import.js", "variable.other.module.js"],
    ...
    it("tokenizes entire module import", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "*",
        scopes: ["source.js", "meta.import.js", "variable.language.import-all.js"],
      });
      expect(tokens[4]).toEqual({
        value: "as",
        scopes: ["source.js", "meta.import.js", "keyword.control.js"],
...
`);
      ...
      expect(lines[0][3]).toEqual({
        value: " comment ",
        scopes: ["source.js", "meta.import.js", "comment.block.js"],
      });
      ...
      expect(lines[1][5]).toEqual({
        value: " comment",
        scopes: ["source.js", "meta.import.js", "comment.line.double-slash.js"],
      });
      expect(lines[2][1]).toEqual({
        value: "/*",
        scopes: [
...
`);
  ...
  describe("ES6 export", function () {
    it("tokenizes named export", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "export",
        scopes: ["source.js", "meta.export.js", "keyword.control.js"],
      });
    ...
    it("tokenizes existing variable export", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "{",
        scopes: ["source.js", "meta.export.js", "punctuation.definition.modules.begin.js"],
      });
      expect(tokens[4]).toEqual({
        value: "bar",
        scopes: ["source.js", "meta.export.js", "variable.other.module.js"],
      });
      expect(tokens[6]).toEqual({
        value: "}",
        scopes: ["source.js", "meta.export.js", "punctuation.definition.modules.end.js"],
      });
      ...
      expect(tokens[5]).toEqual({
        value: ",",
        scopes: ["source.js", "meta.export.js", "meta.delimiter.object.comma.js"],
      });
      expect(tokens[7]).toEqual({
        value: "foo",
        scopes: ["source.js", "meta.export.js", "variable.other.module.js"],
      ...
      expect(tokens[11]).toEqual({
        value: "alias",
        scopes: ["source.js", "meta.export.js", "variable.other.module-alias.js"],
      });
      expect(tokens[13]).toEqual({
        value: "}",
        scopes: ["source.js", "meta.export.js", "punctuation.definition.modules.end.js"],
    ...
    it("tokenizes default export", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "default",
        scopes: ["source.js", "meta.export.js", "variable.language.default.js"],
      });
      expect(tokens[4]).toEqual({
        value: "123",
        scopes: ["source.js", "constant.numeric.decimal.js"],
...
`);
      ...
      expect(lines[1][5]).toEqual({
        value: " comment",
        scopes: ["source.js", "meta.export.js", "comment.line.double-slash.js"],
      });
      expect(lines[2][1]).toEqual({
        value: "/*",
        scopes: [
      ...
      expect(lines[2][2]).toEqual({
        value: " comment ",
        scopes: ["source.js", "meta.export.js", "comment.block.js"],
      });
      expect(lines[2][3]).toEqual({
        value: "*/",
        scopes: [
      ...
      const { tokens } = grammar.tokenizeLine(
        'export {member1, /* comment */ member2} /* comment */ from "module";',
      );
      expect(tokens[6]).toEqual({
        value: "/*",
        scopes: [
    ...
    it("tokenizes default class export", function () {
      ...
      expect(tokens[6]).toEqual({
        value: "{",
        scopes: ["source.js", "punctuation.section.scope.begin.js"],
      });
      expect(tokens[7]).toEqual({
        value: "}",
        scopes: ["source.js", "punctuation.section.scope.end.js"],
      });
    ...
    it("tokenizes re-export", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "*",
        scopes: ["source.js", "meta.export.js", "variable.language.import-all.js"],
      });
      expect(tokens[4]).toEqual({
        value: "from",
        scopes: ["source.js", "meta.export.js", "keyword.control.js"],
...
`);
  ...
  describe("functions", function () {
    it("tokenizes regular function declarations", function () {
      ...
      expect(tokens[5]).toEqual({
        value: "{",
        scopes: ["source.js", "punctuation.definition.function.body.begin.bracket.curly.js"],
      });
      expect(tokens[6]).toEqual({
        value: "}",
        scopes: ["source.js", "punctuation.definition.function.body.end.bracket.curly.js"],
      });
...
`);
    ...
    it("tokenizes async functions", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "async",
        scopes: ["source.js", "meta.function.js", "storage.modifier.async.js"],
      });
      expect(tokens[2]).toEqual({
        value: "function",
        scopes: ["source.js", "meta.function.js", "storage.type.function.js"],
    ...
    it("tokenizes functions as object properties", function () {
      ...
      expect(tokens[1]).toEqual({
        value: ".",
        scopes: ["source.js", "meta.function.js", "meta.delimiter.method.period.js"],
      });
      expect(tokens[2]).toEqual({
        value: "method",
        scopes: ["source.js", "meta.function.js", "entity.name.function.js"],
      ...
      expect(tokens[4]).toEqual({
        value: "=",
        scopes: ["source.js", "meta.function.js", "keyword.operator.assignment.js"],
      });
      expect(tokens[6]).toEqual({
        value: "function",
        scopes: ["source.js", "meta.function.js", "storage.type.function.js"],
    ...
    it("tokenises getter/setter keywords", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "get",
        scopes: ["source.js", "meta.function.method.definition.js", "keyword.operator.getter.js"],
      });
      expect(tokens[2]).toEqual({
        value: "name",
        scopes: ["source.js", "meta.function.method.definition.js", "entity.name.function.js"],
      });
      expect(tokens[3]).toEqual({
        value: "(",
        scopes: [
    ...
    it("tokenizes ES6 method definitions", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "host",
        scopes: ["source.js", "meta.function.method.definition.js", "meta.parameters.js"],
      });
      expect(tokens[4]).toEqual({
        value: ",",
        scopes: [
      ...
      expect(tokens[11]).toEqual({
        value: "Yeah",
        scopes: ["source.js", "string.quoted.double.js"],
      });
    ...
    it("tokenises ES6 methods with computed names", function () {
      ...
      expect(tokens[0]).toEqual({
        ...
        scopes: [
          "source.js",
          "meta.function.method.definition.js",
          "meta.computed-key.js",
          "punctuation.definition.computed-key.begin.bracket.square.js",
        ],
      });
      expect(tokens[2]).toEqual({
        value: "foo",
        scopes: [
          ...
          "meta.function.method.definition.js",
          "meta.computed-key.js",
          "variable.parameter.property.js",
        ],
      });
      expect(tokens[4]).toEqual({
        value: "]",
        scopes: [
          ...
          "meta.function.method.definition.js",
          "meta.computed-key.js",
          "punctuation.definition.computed-key.end.bracket.square.js",
        ],
      });
      expect(tokens[6]).toEqual({
        value: "(",
    ...
    it("tokenizes constructors", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "constructor",
        scopes: ["source.js", "meta.function.js", "entity.name.function.constructor.js"],
      });
      expect(tokens[1]).toEqual({
        value: "(",
        scopes: [
    ...
    it("tokenizes functions in object literals", function () {
      ...
      expect(tokens[1]).toEqual({
        value: ":",
        scopes: ["source.js", "meta.function.json.js", "keyword.operator.assignment.js"],
      });
      expect(tokens[3]).toEqual({
        value: "function",
      ...
      expect(tokens[0]).toEqual({
        value: "function",
        scopes: ["source.js", "meta.function.arrow.json.js", "entity.name.function.js"],
      });
      expect(tokens[2]).toEqual({
        value: ":",
        scopes: ["source.js", "meta.function.arrow.json.js", "keyword.operator.assignment.js"],
      });
      expect(tokens[4]).toEqual({
        value: "a",
        scopes: [
          "source.js",
          "meta.function.arrow.json.js",
          "meta.parameters.js",
          "variable.parameter.function.js",
        ],
      });
      expect(tokens[6]).toEqual({
        value: "=>",
        scopes: ["source.js", "meta.function.arrow.json.js", "storage.type.function.arrow.js"],
      });
    ...
    it("tokenizes generator functions", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "*",
        scopes: ["source.js", "meta.function.js", "storage.modifier.generator.js"],
      });
      expect(tokens[3]).toEqual({
        value: "foo",
        scopes: ["source.js", "meta.function.js", "entity.name.function.js"],
    ...
    it("tokenizes arrow functions", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "=>",
        scopes: ["source.js", "meta.function.arrow.js", "storage.type.function.arrow.js"],
      });
      expect(tokens[3]).toEqual({ value: " x ", scopes: ["source.js"] });
...
`);
    ...
    it("tokenizes stored arrow functions", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "func",
        scopes: ["source.js", "meta.function.arrow.js", "entity.name.function.js"],
      });
      expect(tokens[4]).toEqual({
        value: "=",
        scopes: ["source.js", "meta.function.arrow.js", "keyword.operator.assignment.js"],
      });
      expect(tokens[11]).toEqual({
        value: ")",
        scopes: [
    ...
    it("tokenizes default parameters", function () {
      ...
      expect(tokens[8]).toEqual({
        value: "this",
        scopes: ["source.js", "meta.function.js", "meta.parameters.js", "variable.language.js"],
      });
      expect(tokens[9]).toEqual({
        value: ".",
        scopes: [
    ...
    it("tokenizes the rest parameter", function () {
      let { tokens } = grammar.tokenizeLine("(...args) => args[0]");
      expect(tokens[1]).toEqual({
        value: "...",
        scopes: [
          "source.js",
      ...
      expect(tokens[2]).toEqual({
        ...
        scopes: [
          ...
          "meta.function.arrow.js",
          "meta.parameters.js",
          "variable.parameter.rest.function.js",
        ],
      });
  ...
  describe("function calls", function () {
    it("tokenizes function calls", function () {
      ...
      expect(tokens[10]).toEqual({
        value: "{",
        scopes: ["source.js", "meta.function-call.js", "meta.arguments.js", "meta.brace.curly.js"],
      });
      expect(tokens[11]).toEqual({
        value: "a",
        scopes: ["source.js", "meta.function-call.js", "meta.arguments.js"],
      ...
      expect(tokens[2]).toEqual({
        value: "(",
        scopes: ["source.js", "meta.function-call.js", "meta.arguments.js", "meta.brace.round.js"],
      });
      expect(tokens[3]).toEqual({
        value: "123",
        scopes: [
    ...
    it("tokenizes illegal function calls", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "0illegal",
        scopes: ["source.js", "meta.function-call.js", "invalid.illegal.identifier.js"],
      });
      expect(tokens[1]).toEqual({
        value: "(",
        scopes: [
    ...
    it("tokenizes function declaration as an argument", function () {
      ...
      expect(tokens[11]).toEqual({
        value: "return",
        scopes: ["source.js", "meta.function-call.js", "meta.arguments.js", "keyword.control.js"],
      });
      expect(tokens[12]).toEqual({
        value: " p",
        scopes: ["source.js", "meta.function-call.js", "meta.arguments.js"],
  ...
  describe("method calls", function () {
    it("tokenizes method calls", function () {
      ...
      expect(tokens[1]).toEqual({
        value: ".",
        scopes: ["source.js", "meta.method-call.js", "meta.delimiter.method.period.js"],
      });
      expect(tokens[2]).toEqual({
        value: "b",
        scopes: ["source.js", "meta.method-call.js", "entity.name.function.js"],
      });
      expect(tokens[3]).toEqual({
        value: "(",
        scopes: [
      ...
      expect(tokens[5]).toEqual({
        value: "+",
        scopes: ["source.js", "meta.method-call.js", "meta.arguments.js", "keyword.operator.js"],
      });
      expect(tokens[6]).toEqual({
        value: "1",
        scopes: [
...
`);
    ...
    describe("built-in methods", function () {
      ...
      for (var method of Array.from(methods)) {
        it(`tokenizes '${method}'`, function () {
          ...
          expect(tokens[1]).toEqual({
            value: method,
            scopes: ["source.js", "meta.method-call.js", "support.function.js"],
          });
          expect(tokens[2]).toEqual({
            value: "(",
            scopes: [
      ...
      return Array.from(domMethods).map((domMethod) =>
        it(`tokenizes '${domMethod}'`, function () {
          ...
          expect(tokens[1]).toEqual({
            value: domMethod,
            scopes: ["source.js", "meta.method-call.js", "support.function.dom.js"],
          });
          expect(tokens[2]).toEqual({
            value: "(",
            scopes: [
  ...
  describe("properties", function () {
    it("tokenizes properties", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "property",
        scopes: ["source.js", "variable.other.object.property.js"],
      });
    ...
    it("tokenizes constant properties", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "MY_CONSTANT",
        scopes: ["source.js", "constant.other.property.js"],
      });
      ...
      expect(tokens[2]).toEqual({
        value: "MY_CONSTANT",
        scopes: ["source.js", "constant.other.object.property.js"],
      });
    ...
    it("tokenizes the optional chaining operator", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "?.",
        scopes: ["source.js", "meta.delimiter.property.optional.js"],
      });
      expect(tokens[2]).toEqual({
        value: "prop",
        scopes: ["source.js", "variable.other.property.js"],
      ...
      expect(tokens[3]).toEqual({
        value: "?.",
        scopes: ["source.js", "meta.method-call.js", "meta.delimiter.method.optional.js"],
      });
      expect(tokens[4]).toEqual({
        value: "b",
        scopes: ["source.js", "meta.method-call.js", "entity.name.function.js"],
    ...
    it("detects some illegal uses of the optional chaining operator", function () {
      ...
      expect(tokens[3]).toEqual({
        ...
        scopes: [
          ...
          "meta.class.instance.constructor.js",
          "entity.name.type.instance.js",
          "invalid.illegal.meta.delimiter.property.optional.js",
        ],
      });
      expect(tokens[4]).toEqual({
        value: "b",
      ...
      expect(tokens[1]).toEqual({
        ...
        scopes: [
          "source.js",
          "meta.function.js",
          "invalid.illegal.meta.delimiter.method.optional.js",
        ],
      });
      expect(tokens[2]).toEqual({
        value: "b",
  ...
  describe("strings and functions", () =>
    it("doesn't confuse them", function () {
      ...
      return (() => {
        ...
        for (let scope in delimsByScope) {
          const delim = delimsByScope[scope];
          ({ tokens } = grammar.tokenizeLine(
            "a.push(" + delim + "x" + delim + " + y + " + delim + ":function()" + delim + ");",
          ));
          expect(tokens[2]).toEqual({
            value: "push",
            scopes: ["source.js", "meta.method-call.js", "support.function.js"],
          ...
          expect(tokens[5]).toEqual({
            value: "x",
            scopes: ["source.js", "meta.method-call.js", "meta.arguments.js", scope],
          });
          expect(tokens[6]).toEqual({
            value: delim,
            scopes: [
          ...
          expect(tokens[9]).toEqual({
            value: " y ",
            scopes: ["source.js", "meta.method-call.js", "meta.arguments.js"],
          });
          expect(tokens[10]).toEqual({
            value: "+",
            scopes: [
  ...
  describe("comments", function () {
    it("tokenizes // comments", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "//",
        scopes: ["source.js", "comment.line.double-slash.js", "punctuation.definition.comment.js"],
      });
      ...
      expect(tokens[1]).toEqual({
        value: " stuff",
        scopes: ["source.js", "comment.line.double-slash.js"],
      });
    });
    ...
    it("tokenizes /* */ comments", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "/*",
        scopes: ["source.js", "comment.block.empty.js", "punctuation.definition.comment.begin.js"],
      });
      expect(tokens[1]).toEqual({
        value: "*/",
        scopes: ["source.js", "comment.block.empty.js", "punctuation.definition.comment.end.js"],
      });

      ({ tokens } = grammar.tokenizeLine("/* foo */"));
      expect(tokens[0]).toEqual({
        value: "/*",
        scopes: ["source.js", "comment.block.js", "punctuation.definition.comment.begin.js"],
      });
      expect(tokens[1]).toEqual({ value: " foo ", scopes: ["source.js", "comment.block.js"] });
      expect(tokens[2]).toEqual({
        value: "*/",
        scopes: ["source.js", "comment.block.js", "punctuation.definition.comment.end.js"],
      });
    });
...
`);
      ...
      expect(lines[1][1]).toEqual({
        value: " comment",
        scopes: ["source.js", "meta.function.js", "comment.line.double-slash.js"],
      });
      expect(lines[2][0]).toEqual({
        value: "foo",
        scopes: ["source.js", "meta.function.js", "entity.name.function.js"],
...
`);
    ...
    it("tokenizes comments inside function parameters correctly", function () {
      ...
      expect(tokens[7]).toEqual({
        value: ", p2 ",
        scopes: ["source.js", "meta.function.js", "meta.parameters.js", "comment.block.js"],
      });
      expect(tokens[8]).toEqual({
        value: "*/",
        scopes: [
  ...
  describe("console", function () {
    it("tokenizes the console keyword", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "console",
        scopes: ["source.js", "entity.name.type.object.console.js"],
      });
      expect(tokens[1]).toEqual({
        value: ";",
        scopes: ["source.js", "punctuation.terminator.statement.js"],
    ...
    it("tokenizes console support functions", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "log",
        scopes: ["source.js", "meta.method-call.js", "support.function.console.js"],
      });
      expect(tokens[3]).toEqual({
        value: "(",
        scopes: [
...
`);
  ...
  describe("json", function () {
    ...
    it("tokenizes json support functions", function () {
      const { tokens } = grammar.tokenizeLine("JSON.parse();");
      expect(tokens[0]).toEqual({ value: "JSON", scopes: ["source.js", "support.class.json.js"] });
      expect(tokens[1]).toEqual({
        value: ".",
        scopes: ["source.js", "meta.method-call.js", "meta.delimiter.method.period.js"],
      ...
      expect(tokens[2]).toEqual({
        value: "parse",
        scopes: ["source.js", "meta.method-call.js", "support.function.json.js"],
      });
      expect(tokens[3]).toEqual({
        value: "(",
        scopes: [
...
`);
      expect(lines[0][0]).toEqual({
        value: "JSON",
        scopes: ["source.js", "support.class.json.js"],
      });
      expect(lines[1][0]).toEqual({
        value: ".",
        scopes: ["source.js", "meta.method-call.js", "meta.delimiter.method.period.js"],
  ...
  describe("math", function () {
    ...
    it("tokenizes math support functions/properties", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "random",
        scopes: ["source.js", "meta.method-call.js", "support.function.math.js"],
      });
      expect(tokens[3]).toEqual({
        value: "(",
        scopes: [
...
`);
      expect(lines[0][0]).toEqual({
        value: "Math",
        scopes: ["source.js", "support.class.math.js"],
      });
      expect(lines[1][0]).toEqual({
        value: ".",
        scopes: ["source.js", "meta.method-call.js", "meta.delimiter.method.period.js"],
      ...
      expect(tokens[2]).toEqual({
        value: "PI",
        scopes: ["source.js", "support.constant.property.math.js"],
      });
      expect(tokens[3]).toEqual({
        value: ";",
        scopes: ["source.js", "punctuation.terminator.statement.js"],
  ...
  describe("promise", function () {
    it("tokenizes the promise object", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "Promise",
        scopes: ["source.js", "support.class.promise.js"],
      });
      expect(tokens[1]).toEqual({
        value: ";",
        scopes: ["source.js", "punctuation.terminator.statement.js"],
    ...
    it("tokenizes promise support functions", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "race",
        scopes: ["source.js", "meta.method-call.js", "support.function.promise.js"],
      });
      expect(tokens[3]).toEqual({
        value: "(",
        scopes: [
...
`);
  ...
  describe("object literals", function () {
    ...
    it("tokenizes object keys", function () {
      ...
      expect(tokens[0]).toEqual({
        value: '"',
        scopes: ["source.js", "string.quoted.double.js", "punctuation.definition.string.begin.js"],
      });
      expect(tokens[1]).toEqual({ value: "key", scopes: ["source.js", "string.quoted.double.js"] });
      expect(tokens[2]).toEqual({
        value: '"',
        scopes: ["source.js", "string.quoted.double.js", "punctuation.definition.string.end.js"],
      });
      expect(tokens[3]).toEqual({
        value: ":",
        scopes: ["source.js", "keyword.operator.assignment.js"],
  ...
  describe("ternary expressions", function () {
    ...
    it("tokenizes regular expressions inside ternary expressions", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "?",
        scopes: ["source.js", "keyword.operator.ternary.js"],
      });
      expect(tokens[2]).toEqual({ value: " ", scopes: ["source.js", "string.regexp.js"] });
      expect(tokens[3]).toEqual({
        value: "/",
  ...
  describe("switch statements", function () {
    it("tokenizes the switch keyword", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "switch",
        scopes: ["source.js", "meta.switch-statement.js", "keyword.control.switch.js"],
      });
    });
    ...
    it("tokenizes switch expression", function () {
      ...
      expect(tokens[1]).toEqual({
        ...
        scopes: [
          ...
          "punctuation.definition.switch-expression.begin.bracket.round.js",
        ],
      });
      expect(tokens[2]).toEqual({
        value: "foo ",
        scopes: ["source.js", "meta.switch-statement.js"],
      });
      expect(tokens[3]).toEqual({
        value: "+",
        scopes: ["source.js", "meta.switch-statement.js", "keyword.operator.js"],
      });
      expect(tokens[4]).toEqual({
        value: " bar",
        scopes: ["source.js", "meta.switch-statement.js"],
      ...
      expect(tokens[5]).toEqual({
        ...
        scopes: [
          "source.js",
          "meta.switch-statement.js",
          "punctuation.definition.switch-expression.end.bracket.round.js",
        ],
      });
    });
...
`);
      expect(lines[1][0]).toEqual({
        ...
        scopes: [
          "source.js",
          "meta.switch-statement.js",
          "punctuation.definition.section.switch-block.begin.bracket.curly.js",
        ],
      });
      expect(lines[2][1]).toEqual({
        value: "case",
        scopes: ["source.js", "meta.switch-statement.js", "keyword.control.case.js"],
      });
      expect(lines[2][3]).toEqual({
        value: "abc",
        scopes: ["source.js", "meta.switch-statement.js"],
      ...
      expect(lines[3][3]).toEqual({
        value: "1",
        scopes: ["source.js", "meta.switch-statement.js", "constant.numeric.decimal.js"],
      });
      ...
      expect(lines[5][1]).toEqual({
        value: "break",
        scopes: ["source.js", "meta.switch-statement.js", "keyword.control.js"],
      });
      expect(lines[5][2]).toEqual({
        value: ";",
        scopes: ["source.js", "meta.switch-statement.js", "punctuation.terminator.statement.js"],
      });
      ...
      expect(lines[6][3]).toEqual({
        value: "null",
        scopes: ["source.js", "meta.switch-statement.js", "constant.language.null.js"],
      });
      ...
      expect(lines[7][1]).toEqual({
        value: "default",
        scopes: ["source.js", "meta.switch-statement.js", "keyword.control.default.js"],
      });
      ...
      expect(lines[8][0]).toEqual({
        ...
        scopes: [
          "source.js",
          "meta.switch-statement.js",
          "punctuation.definition.section.switch-block.end.bracket.curly.js",
        ],
      });
    });
  });
  ...
  describe("indentation", function () {
    ...
    const expectPreservedIndentation = function (text) {
      ...
      return Array.from(actualLines).map((actualLine, i) =>
        expect([actualLine, editor.indentLevelForLine(actualLine)]).toEqual([
          expectedLines[i],
